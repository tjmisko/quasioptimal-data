"""H3: the engineer stock tracks the physical capital stock (cointegrated, positive elasticity).
...
def main() -> int:
    ...
    mreg = analysis.multiple_regression(frame, "engineers", [COVARIATE, "gdp_real"])
